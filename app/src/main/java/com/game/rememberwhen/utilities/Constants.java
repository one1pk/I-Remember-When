...
public class Constants {
    ...
    public static final String KEY_COLLECTION_PLAYERS = "players";
    ...
    public static final String KEY_PLAYER_TYPE_HOST = "host";
    public static final String KEY_PLAYER_TYPE_NORMAL = "player";
    public static final String KEY_PLAYER_TYPE_TELLER = "storyteller";
    public static final String KEY_PLAYER_TYPE_LISTNER = "listener";
