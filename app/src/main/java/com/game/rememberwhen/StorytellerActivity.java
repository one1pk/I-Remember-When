...
//        timerTextView = (TextView) findViewById(R.id.timer); //TODO: Initiate this inside other activity-->deliberation_StoryTeller
        database = FirebaseDatabase.getInstance();
        loadDataset();
//        truthButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Toast.makeText(StorytellerActivity.this, "OnClick: TRUTH BUTTON", Toast.LENGTH_SHORT).show();
